...
import { idlFactory } from './vault_core.did.js';
export { idlFactory } from './vault_core.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_VAULT_CORE;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./vault_core.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the vault_core canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./vault_core.did.js")._SERVICE>}
 */
export const vault_core = createActor(canisterId);
