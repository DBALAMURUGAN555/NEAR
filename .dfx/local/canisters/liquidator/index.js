...
import { idlFactory } from './liquidator.did.js';
export { idlFactory } from './liquidator.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_LIQUIDATOR;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./liquidator.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the liquidator canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./liquidator.did.js")._SERVICE>}
 */
export const liquidator = createActor(canisterId);
