...
import { idlFactory } from './btc_integration.did.js';
export { idlFactory } from './btc_integration.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_BTC_INTEGRATION;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./btc_integration.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the btc_integration canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./btc_integration.did.js")._SERVICE>}
 */
export const btc_integration = createActor(canisterId);
