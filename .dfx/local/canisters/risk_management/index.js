...
import { idlFactory } from './risk_management.did.js';
export { idlFactory } from './risk_management.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_RISK_MANAGEMENT;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./risk_management.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the risk_management canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./risk_management.did.js")._SERVICE>}
 */
export const risk_management = createActor(canisterId);
