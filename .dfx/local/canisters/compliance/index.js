...
import { idlFactory } from './compliance.did.js';
export { idlFactory } from './compliance.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_COMPLIANCE;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./compliance.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the compliance canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./compliance.did.js")._SERVICE>}
 */
export const compliance = createActor(canisterId);
