...
import { idlFactory } from './yield_engine.did.js';
export { idlFactory } from './yield_engine.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_YIELD_ENGINE;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./yield_engine.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the yield_engine canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./yield_engine.did.js")._SERVICE>}
 */
export const yield_engine = createActor(canisterId);
